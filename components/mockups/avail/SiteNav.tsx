...
/**
 * SiteNav — sticky glass navigation. Transparent over the dark slipstream hero,
    ...
    >
      ...
      >
        ...
        <Link
          href="#top"
          className={cn(
            "group flex items-center gap-2.5 rounded-md focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--color-accent)]",
          )}
        >
          <span
            aria-hidden
            className="grid h-8 w-8 place-items-center rounded-lg bg-[var(--color-accent)] text-[var(--color-accent-fg)] shadow-[0_6px_18px_-6px_oklch(52%_0.2_264_/_0.7)]"
          >
            <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" aria-hidden>
              <path
                d="M4 17 L11 6 L13 6 L20 17 M8 14 H16"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
          ...
          >
            Avail<span className="text-[var(--color-accent)]"> Aesthetics</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="#book"
            className={cn(
              "inline-flex items-center gap-1.5 rounded-full bg-[var(--color-accent)] px-5 py-2.5 text-sm font-semibold text-[var(--color-accent-fg)]",
              "shadow-[0_10px_30px_-12px_oklch(52%_0.2_264_/_0.8)] transition-transform duration-300 hover:-translate-y-0.5",
              "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]",
            )}
          >
            Book
