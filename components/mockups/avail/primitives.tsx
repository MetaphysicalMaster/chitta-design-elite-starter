...
/**
 * Shared Avail primitives — SectionHeading, Reveal, BrandImage (self-contained
 * placeholder "plate"), and small atoms. Keeps section files lean and the
 * brand system consistent. No external image assets — placeholder plates are
 * engineered cobalt/graphite gradients, each marked "sample" where shown.
 */
...
export function SectionHeading({
  ...
  return (
    ...
    >
      <p
        className={cn(
          "rule-cobalt inline-block text-xs font-semibold uppercase tracking-[0.24em]",
      ...
      <h2
        ...
        style={{ fontSize: "var(--fluid-h2)", lineHeight: 1.04, fontWeight: 600 }}
      >
        {title}
      </h2>
      {lead && (
...
/* ---- BrandImage: self-contained engineered placeholder plate ----
   No network assets; a cohesive cobalt/graphite gradient with an optional
  ...
  return (
    <div
      ...
      className={cn(
        ...
        cool ? "av-plate av-plate--cool" : "av-plate",
        RADIUS[radius],
        className,
      )}
      ...
      {label && (
        <span
          className={cn(
            ...
            cool ? "bg-white/12 text-white/85" : "bg-[var(--color-fg)]/8 text-[var(--color-fg)]/80",
          )}
        >
          {label}
        </span>
...
export const btnPrimary = cn(
  ...
  "shadow-[0_16px_44px_-16px_oklch(52%_0.2_264_/_0.6)]",
  "transition-[transform,box-shadow] duration-300 ease-out",
  "hover:-translate-y-0.5 hover:shadow-[0_22px_56px_-14px_oklch(52%_0.2_264_/_0.75)]",
