...
/**
 * BeforeAfter — interactive drag slider, on a dark graphite field so the cobalt
 * results pop. Pointer + full keyboard support (arrows/Home/End on the handle).
 * Placeholder gradient "plates" clearly marked "sample · illustrative".
 */
...
const CASES: Case[] = [
  {
    ...
    before: "linear-gradient(155deg, oklch(82% 0.02 262), oklch(74% 0.03 262))",
    after: "linear-gradient(155deg, oklch(90% 0.04 262), oklch(82% 0.06 264))",
  },
  {
    id: "filler",
    treatment: "Dermal Filler — Cheek & Lip",
    detail: "2.0ml · 2-week follow-up",
    before: "radial-gradient(120% 120% at 40% 30%, oklch(84% 0.03 40), oklch(74% 0.04 30))",
    after: "radial-gradient(120% 120% at 40% 30%, oklch(88% 0.05 18), oklch(80% 0.07 14))",
  },
  {
    id: "morpheus",
    treatment: "Morpheus8 — Texture & Tone",
    detail: "3 sessions · skin remodeling",
    before: "radial-gradient(130% 100% at 60% 40%, oklch(80% 0.03 60), oklch(70% 0.05 50))",
    after: "radial-gradient(130% 100% at 60% 40%, oklch(89% 0.04 262), oklch(82% 0.06 264))",
  },
];
...
function SliderHandle({
  ...
  return (
    <>
      ...
      >
        <div className="relative h-full w-0.5 bg-white/90 shadow-[0_0_0_1px_oklch(52%_0.2_264_/_0.3)]" />
      </div>
      <button
        type="button"
        role="slider"
    ...
    <figure className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-[var(--glass-shadow)]">
      ...
      >
        ...
        <div
          ...
          aria-hidden
        >
          <span className="absolute left-3 top-3 rounded-full bg-[var(--graphite-0)]/85 px-2.5 py-1 text-[0.62rem] font-semibold uppercase tracking-wider text-white">
            Before
          </span>
        </div>
...
export function BeforeAfter() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, var(--graphite-0), var(--graphite-1))",
      }}
    >
      {/* slipstream aura echoing the hero on the dark field */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 opacity-40"
        style={{
          background:
            "radial-gradient(55% 50% at 85% 0%, var(--streak-core), transparent 70%), radial-gradient(50% 50% at 0% 100%, var(--streak-cool), transparent 72%)",
        }}
      />
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8">
        <SectionHeading
          ...
          lead="The before/after gallery their current site doesn't have. Slide the handle — or use your keyboard — to compare representative treatment outcomes across our menu."
        />
