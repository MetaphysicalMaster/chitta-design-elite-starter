...
/**
 * BeforeAfter — interactive drag slider on a rice-paper field. Pointer + full
 * keyboard support (arrows/Home/End on the handle). Placeholder gradient
 * "plates" clearly marked "sample · illustrative". Botanical: a light, airy
...
const CASES: Case[] = [
  {
    ...
    before: "linear-gradient(155deg, oklch(86% 0.02 350), oklch(80% 0.03 348))",
    after: "linear-gradient(155deg, oklch(93% 0.035 352), oklch(87% 0.06 354))",
  },
  {
    id: "ipl",
    treatment: "IPL Photofacial — Pigment & Tone",
    detail: "Three-session plan · 8 weeks",
    before: "radial-gradient(120% 120% at 40% 30%, oklch(85% 0.025 348), oklch(78% 0.03 346))",
    after: "radial-gradient(120% 120% at 40% 30%, oklch(92% 0.04 352), oklch(86% 0.07 354))",
  },
  {
    id: "filler",
    treatment: "Liquid Facial Balancing",
    detail: "Full-face plan · proportion-led",
    before: "radial-gradient(130% 100% at 60% 40%, oklch(84% 0.025 346), oklch(77% 0.03 344))",
    after: "radial-gradient(130% 100% at 60% 40%, oklch(91% 0.06 352), oklch(85% 0.1 356))",
  },
];
...
function SliderHandle({
  ...
  return (
    <>
      ...
      >
        <div className="relative h-full w-px bg-white/95 shadow-[0_0_0_1px_oklch(64%_0.13_354_/_0.3)]" />
      </div>
      <button
        type="button"
        role="slider"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 46% at 86% 0%, oklch(92% 0.05 352 / 0.7), transparent 70%), radial-gradient(46% 50% at 0% 100%, var(--color-accent-subtle), transparent 72%)",
        }}
      />
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <SectionHeading
          ...
          title={
            <>
              See the difference.{" "}
              <span className="font-display-em italic">Drag to reveal.</span>
            </>
          }
          lead="The before/after gallery a broken SEO template could never show. Slide the handle — or use your keyboard — to compare representative outcomes from Dr. Phuah's chair."
        />
