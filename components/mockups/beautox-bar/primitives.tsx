 ...
 *
 * The motion has a touch more "bounce" than the couture siblings (a softer,
 * springier ease) to read as fun — but it stays tasteful. All motion honors
 * prefers-reduced-motion (no transforms, instant show).
 */
...
/* A slightly springy ease — playful pop without overshooting into gimmick. */
...
export function SectionHeading({
  ...
  align?: "left" | "center";
  className?: string;
  /** "dark" = sits on the candy-night sections. */
  tone?: "light" | "dark";
}) {
  return (
    <div
...
export const ctaGhost = cn(
  ...
  "border-2 border-[var(--color-accent)] font-semibold text-[var(--color-accent-deep)]",
  "transition-colors duration-300 hover:bg-[var(--color-accent-subtle)]",
  "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]",
);
