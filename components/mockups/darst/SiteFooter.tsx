        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-[40ch] text-[0.92rem] leading-relaxed text-[var(--color-fg-muted)]">
              ...
              Medical, surgical and cosmetic dermatology for Charlotte and
              Monroe, for over two decades.
            </p>

            <p className="mt-5 text-[0.7rem] font-semibold uppercase tracking-[0.2em] text-[var(--color-fg-subtle)]">
              Two North Carolina offices
            </p>

            {/* BOTH real locations — a single clean, authoritative listing per
                city (the structural opposite of the live site's scattered,
                location-keyword-stuffed pages). */}
            <div className="mt-3 grid gap-6 sm:grid-cols-2">
              {NAP.locations.map((loc) => (
                <address key={loc.city} className="not-italic">
                  <p className="text-[0.78rem] font-semibold uppercase tracking-[0.14em] text-[var(--color-accent-deep)]">
                    {loc.city}
                  </p>
                  <p className="mt-1.5 text-[0.95rem] font-medium text-[var(--color-fg)] tnum">
                    {loc.street}
                  </p>
            ...
            <p className="mt-4 text-[0.9rem] text-[var(--color-fg-subtle)]">
              {NAP.hours}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-[0.95rem] leading-relaxed text-[var(--color-fg-muted)]">
              We welcome new patients across the Charlotte and Monroe areas. Most
              ...
              {NAP.locations.map((loc) => (
                <li key={loc.city}>
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-[0.95rem] font-medium text-[var(--color-accent-deep)] underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent-deep)]"
                  >
                    Directions to {loc.city}
