...
/**
 * Shared clinical-academic primitives for the Darst mockup:
 * - Reveal / RevealGroup / RevealItem  (scroll choreography, reduced-motion safe)
 * - SectionHeading                     (eyebrow + editorial serif title + lead)
 ...
 * voice is measured — shorter travel, calmer easing than the spa siblings.
 */
...
export function SectionHeading({
  ...
  align?: "left" | "center";
  className?: string;
  /** "dark" = sits on the navy night sections. */
  tone?: "light" | "dark";
}) {
  return (
    <div
    ...
    >
      <Reveal>
        <p
          className={cn(
            "eyebrow rule-accent inline-block",
            align === "center" && "rule-accent-center",
            tone === "dark"
