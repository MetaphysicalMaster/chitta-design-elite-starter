    ...
    >
      <defs>
        <linearGradient id="dt-strata" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="oklch(92% 0.012 250)" />
          <stop offset="14%" stopColor="oklch(78% 0.03 249)" />
          <stop offset="34%" stopColor="oklch(58% 0.06 250)" />
          <stop offset="64%" stopColor="oklch(38% 0.06 252)" />
          <stop offset="100%" stopColor="oklch(18% 0.035 254)" />
        </linearGradient>
      ...
      {/* the lone oxblood capillary — a meandering vessel through the dermis */}
      <path
        d="M -10 230 C 120 200, 200 268, 330 236 S 560 200, 690 250 S 820 232, 820 232"
        fill="none"
        stroke="oklch(52% 0.16 24)"
        strokeWidth="2.4"
        strokeLinecap="round"
        opacity="0.9"
      />
      ...
      <path
        ...
        fill="none"
        stroke="oklch(88% 0.02 250 / 0.5)"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
      <circle cx="612" cy="344" r="9" fill="none" stroke="oklch(80% 0.03 250 / 0.5)" strokeWidth="2" />
