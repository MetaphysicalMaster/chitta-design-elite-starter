...
`;function u(e,t,r){return e+(t-e)*(1-Math.pow(.004,r))}function c({pointer:e,descent:r,lite:h}){let p=(0,i.useRef)(null),d=(0,i.useRef)(0),f=(0,i.useRef)(0),m=(0,i.useRef)({x:0,y:0,s:0}),v=(0,i.useRef)(.5),g=(0,i.useRef)(0),{geometry:b,uniforms:y}=(0,i.useMemo)(()=>{let e,t=function(e,t){let r=new Float32Array(3*e),a=new Float32Array(3*e),o=new Float32Array(e),i=new Float32Array(e),l=new Float32Array(e),n=new Float32Array(e),u=Math.floor(.07*e);for(let c=0;c<e;c++){let e,h,p,d;if(c<u){let r=c/u;e=(r-.5)*3.4040000000000004,d=.62+.12*Math.sin(r*Math.PI*3)+(t()-.5)*.04,h=s.MathUtils.lerp(1,-1,d)+(t()-.5)*.04,p=.18*Math.cos(r*Math.PI*4)+(t()-.5)*.04,i[c]=1}else{e=(2*t()-1)*1.85;d=Math.min(1,Math.max(0,(d=Math.pow(t(),.85))+(t()-.5)*.06)),h=s.MathUtils.lerp(1,-1,d)+(t()-.5)*.05,p=(t()-.5)*.42*(.5+.5*d),i[c]=0}r[3*c]=e,r[3*c+1]=h,r[3*c+2]=p;let f=1.7*Math.pow(t(),.5),m=t()*Math.PI*2,v=Math.acos(2*t()-1);a[3*c]=f*Math.sin(v)*Math.cos(m)*1.5,a[3*c+1]=f*Math.sin(v)*Math.sin(m)*.9,a[3*c+2]=f*Math.cos(v)*.6,o[c]=d,l[c]=t(),n[c]=.7+.8*t()}return{lattice:r,cloud:a,depth:o,vessel:i,seed:l,scale:n}}(h?Math.floor(3960.0000000000005):7200,(e=40719,function(){e|=0;let t=Math.imul((e=e+0x6d2b79f5|0)^e>>>15,1|e);return(((t=t+Math.imul(t^t>>>7,61|t)^t)^t>>>14)>>>0)/0x100000000})),r=new s.BufferGeometry;return r.setAttribute("position",new s.BufferAttribute(t.lattice.slice(),3)),r.setAttribute("aLattice",new s.BufferAttribute(t.lattice,3)),r.setAttribute("aCloud",new s.BufferAttribute(t.cloud,3)),r.setAttribute("aDepth",new s.BufferAttribute(t.depth,1)),r.setAttribute("aVessel",new s.BufferAttribute(t.vessel,1)),r.setAttribute("aSeed",new s.BufferAttribute(t.seed,1)),r.setAttribute("aScale",new s.BufferAttribute(t.scale,1)),{geometry:r,uniforms:{uTime:{value:0},uResolve:{value:0},uIntro:{value:0},uDpr:{value:1},uSize:{value:h?4.4:5.2},uFocus:{value:.5},uPointer:{value:new s.Vector2(0,0)},uPointerStr:{value:0},uCorneum:{value:new s.Color("#ece2d4")},uEpidermis:{value:new s.Color("#c2a886")},uDermis:{value:new s.Color("#8a6a4c")},uDeep:{value:new s.Color("#3a2c20")},uVessel:{value:new s.Color("#2f9fa6")}}}},[h]),{gl:x}=(0,o.useThree)();return(0,a.useFrame)(({clock:t},a)=>{let o=p.current;if(!o)return;let i=Math.min(a,1/30),l=t.getElapsedTime();o.uniforms.uTime.value=l,o.uniforms.uDpr.value=Math.min(x.getPixelRatio(),2),d.current+=(1-d.current)*Math.min(1,.9*i),o.uniforms.uIntro.value=d.current,f.current+=(1-f.current)*Math.min(1,.5*i),o.uniforms.uResolve.value=f.current;let n=r.current?.p??0;g.current=u(g.current,n,i);let c=g.current,h=.5+.32*Math.sin(.16*l),b=Math.min(1,7*c);v.current=s.MathUtils.lerp(h,.06+.86*c,b),o.uniforms.uFocus.value=v.current;let y=e.current??{x:0,y:0,active:0},w=1-Math.pow(.0022,i);m.current.x+=(y.x-m.current.x)*w,m.current.y+=(y.y-m.current.y)*w,m.current.s+=(y.active-m.current.s)*Math.min(1,3*i),o.uniforms.uPointer.value.set(m.current.x,m.current.y),o.uniforms.uPointerStr.value=m.current.s}),(0,t.jsx)("points",{geometry:b,frustumCulled:!1,children:(0,t.jsx)("shaderMaterial",{ref:p,vertexShader:l,fragmentShader:n,uniforms:y,transparent:!0,depthWrite:!1,depthTest:!1,blending:s.NormalBlending})})}function h({descent:e,children:r}){let o=(0,i.useRef)(null),s=(0,i.useRef)(0);return(0,a.useFrame)(({clock:t},r)=>{let a=o.current;if(!a)return;let i=Math.min(r,1/30),l=t.getElapsedTime();s.current=u(s.current,e.current?.p??0,i);let n=1-.85*Math.min(1,4*s.current);a.rotation.y=.1*Math.sin(.12*l)*n,a.rotation.x=.035*Math.sin(.09*l)*n}),(0,t.jsx)("group",{ref:o,children:r})}function p({descent:e}){let t=(0,i.useRef)(0);return(0,a.useFrame)(({camera:r},a)=>{let o=Math.min(a,1/30);t.current=u(t.current,e.current?.p??0,o);let i=t.current,l=i*i*(3-2*i);r.position.y=s.MathUtils.lerp(.52,-.82,l),r.position.z=s.MathUtils.lerp(4.2,3.15,l),r.lookAt(0,.94*r.position.y,0)}),null}let d={current:{p:0}};e.s(["default",0,function({lite:e=!1,descent:a}){let o=(0,i.useRef)({x:0,y:0,active:0}),s=a??d;return(0,t.jsx)("div",{className:"absolute inset-0",onPointerMove:e=>{let t=e.currentTarget.getBoundingClientRect();o.current.x=(e.clientX-t.left)/t.width*2-1,o.current.y=-((e.clientY-t.top)/t.height*2-1),o.current.active=1},onPointerLeave:()=>{o.current.active=0},children:(0,t.jsxs)(r.Canvas,{camera:{position:[0,0,4.2],fov:40},dpr:[1,2],gl:{antialias:!0,alpha:!0,powerPreference:"high-performance"},style:{position:"absolute",inset:0},children:[(0,t.jsx)(p,{descent:s}),(0,t.jsx)(h,{descent:s,children:(0,t.jsx)(c,{pointer:o,descent:s,lite:e})})]})})}],74422)},18435,e=>{e.n(e.i(74422))}]);