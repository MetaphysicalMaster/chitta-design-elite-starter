...
`)},Object.keys(this.uniforms).forEach(e=>Object.defineProperty(this,e,{get:()=>this.uniforms[e].value,set:t=>this.uniforms[e].value=t}))}}let p=s.forwardRef(({buffer:e,transmissionSampler:t=!1,backside:r=!1,side:o=n.FrontSide,transmission:i=1,thickness:u=0,backsideThickness:f=0,backsideEnvMapIntensity:p=1,samples:h=10,resolution:g,backsideResolution:x,background:y,anisotropy:b,anisotropicBlur:M,...S},w)=>{let C,_,R,F;(0,l.extend)({MeshTransmissionMaterial:v});let T=s.useRef(null),[A]=s.useState(()=>new d),j=m(x||g),P=m(g);return(0,c.useFrame)(e=>{if(T.current.time=e.clock.elapsedTime,T.current.buffer===P.texture&&!t){var i;(F=null==(i=T.current.__r3f.parent)?void 0:i.object)&&(R=e.gl.toneMapping,C=e.scene.background,_=T.current.envMapIntensity,e.gl.toneMapping=n.NoToneMapping,y&&(e.scene.background=y),F.material=A,r&&(e.gl.setRenderTarget(j),e.gl.render(e.scene,e.camera),F.material=T.current,F.material.buffer=j.texture,F.material.thickness=f,F.material.side=n.BackSide,F.material.envMapIntensity=p),e.gl.setRenderTarget(P),e.gl.render(e.scene,e.camera),F.material=T.current,F.material.thickness=u,F.material.side=o,F.material.buffer=P.texture,F.material.envMapIntensity=_,e.scene.background=C,e.gl.setRenderTarget(null),e.gl.toneMapping=R)}}),s.useImperativeHandle(w,()=>T.current,[]),s.createElement("meshTransmissionMaterial",(0,a.default)({args:[h,t],ref:T},S,{buffer:e||P.texture,_transmission:i,anisotropicBlur:null!=M?M:b,transmission:t?i:0,thickness:u,side:o}))});e.s(["MeshTransmissionMaterial",0,p],4020)},38653,e=>{"use strict";var t=e.i(44180),r=e.i(4430),o=e.i(96996),i=e.i(15746),a=e.i(74303),n=e.i(79358),s=e.i(45333),l=e.i(4020),c=e.i(71611),u=e.i(64556),m=e.i(21348),f=e.i(17866);let d=parseInt(m.REVISION.replace(/\D+/g,""));class v extends m.ShaderMaterial{constructor(){super({uniforms:{time:{value:0},pixelRatio:{value:1}},vertexShader:`
      ...
      `})}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}get pixelRatio(){return this.uniforms.pixelRatio.value}set pixelRatio(e){this.uniforms.pixelRatio.value=e}}let p=e=>e&&e.constructor===Float32Array,h=e=>e instanceof m.Vector2||e instanceof m.Vector3||e instanceof m.Vector4,g=e=>Array.isArray(e)?e:h(e)?e.toArray():[e,e,e];function x(e,t,r){return u.useMemo(()=>{if(void 0!==t)if(p(t))return t;else{if(t instanceof m.Color){let r=Array.from({length:3*e},()=>[t.r,t.g,t.b]).flat();return Float32Array.from(r)}if(h(t)||Array.isArray(t)){let r=Array.from({length:3*e},()=>g(t)).flat();return Float32Array.from(r)}return Float32Array.from({length:e},()=>t)}return Float32Array.from({length:e},r)},[t])}let y=u.forwardRef(({noise:e=1,count:t=100,speed:r=1,opacity:a=1,scale:n=1,size:s,color:l,children:d,...h},y)=>{u.useMemo(()=>(0,f.extend)({SparklesImplMaterial:v}),[]);let b=u.useRef(null),M=(0,i.useThree)(e=>e.viewport.dpr),S=g(n),w=u.useMemo(()=>Float32Array.from(Array.from({length:t},()=>S.map(m.MathUtils.randFloatSpread)).flat()),[t,...S]),C=x(t,s,Math.random),_=x(t,a),R=x(t,r),F=x(3*t,e),T=x(void 0===l?3*t:t,p(l)?l:new m.Color(l),()=>1);return(0,o.useFrame)(e=>{b.current&&b.current.material&&(b.current.material.time=e.clock.elapsedTime)}),u.useImperativeHandle(y,()=>b.current,[]),u.createElement("points",(0,c.default)({key:`particle-${t}-${JSON.stringify(n)}`},h,{ref:b}),u.createElement("bufferGeometry",null,u.createElement("bufferAttribute",{attach:"attributes-position",args:[w,3]}),u.createElement("bufferAttribute",{attach:"attributes-size",args:[C,1]}),u.createElement("bufferAttribute",{attach:"attributes-opacity",args:[_,1]}),u.createElement("bufferAttribute",{attach:"attributes-speed",args:[R,1]}),u.createElement("bufferAttribute",{attach:"attributes-color",args:[T,3]}),u.createElement("bufferAttribute",{attach:"attributes-noise",args:[F,3]})),d||u.createElement("sparklesImplMaterial",{transparent:!0,pixelRatio:M,depthWrite:!1}))});var b=e.i(36939),M=e.i(43050);let S=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`,C="#1b2230";function _({pointer:e}){let r=(0,u.useRef)(null),{size:a,viewport:n}=(0,i.useThree)(),s=(0,u.useRef)({x:0,y:0}),l=(0,u.useMemo)(()=>({u_time:{value:0},u_resolution:{value:new m.Vector2(a.width,a.height)},u_pointer:{value:new m.Vector2(0,0)},u_intensity:{value:0},u_void0:{value:new m.Color(C)},u_void1:{value:new m.Color("#262f42")},u_beam:{value:new m.Color("#f3e6c8")},u_beamCool:{value:new m.Color("#cfe4f1")}}),[]);return(0,o.useFrame)(({clock:t},o)=>{let i=r.current;if(!i)return;i.uniforms.u_time.value=t.getElapsedTime(),i.uniforms.u_resolution.value.set(a.width,a.height);let n=e.current??{x:0,y:0},l=1-Math.pow(.0015,o);s.current.x+=(n.x-s.current.x)*l,s.current.y+=(n.y-s.current.y)*l,i.uniforms.u_pointer.value.set(s.current.x,s.current.y);let c=i.uniforms.u_intensity.value;i.uniforms.u_intensity.value=c+(1-c)*Math.min(1,1.1*o)}),(0,t.jsxs)("mesh",{scale:[n.width,n.height,1],children:[(0,t.jsx)("planeGeometry",{args:[1,1]}),(0,t.jsx)("shaderMaterial",{ref:r,vertexShader:S,fragmentShader:w,uniforms:l,depthWrite:!1})]})}function R({pointer:e}){let r=(0,u.useRef)(null),i=(0,u.useRef)(null);return(0,o.useFrame)(({clock:t},o)=>{let i=r.current;if(!i)return;let a=t.getElapsedTime(),n=e.current??{x:0,y:0};i.rotation.y+=.18*o;let s=1-Math.pow(.0025,o),l=.32*n.y+.05*Math.sin(.4*a),c=-(.28*n.x);i.rotation.x+=(l-i.rotation.x)*s,i.rotation.z+=(c-i.rotation.z)*s;let u=1+.018*Math.sin(.55*a);i.scale.setScalar(u)}),(0,t.jsx)(a.Float,{speed:1,rotationIntensity:.18,floatIntensity:.5,children:(0,t.jsx)("group",{ref:r,children:(0,t.jsxs)("mesh",{ref:i,castShadow:!0,children:[(0,t.jsx)("octahedronGeometry",{args:[1.18,0]}),(0,t.jsx)(l.MeshTransmissionMaterial,{samples:8,resolution:512,thickness:1.4,roughness:.02,ior:1.42,chromaticAberration:.9,anisotropy:.35,distortion:.18,distortionScale:.45,temporalDistortion:.08,clearcoat:1,clearcoatRoughness:.05,color:"#ffffff",attenuationColor:"#bcd2e6",attenuationDistance:2.4,background:new m.Color(C)})]})})})}function F(){return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("ambientLight",{intensity:.32}),(0,t.jsxs)(n.Environment,{resolution:256,frames:1,children:[(0,t.jsx)(s.Lightformer,{form:"rect",intensity:3.2,color:"#fbeccb",position:[-3.2,3.4,2],rotation:[-Math.PI/5,0,0],scale:[5,9,1]}),(0,t.jsx)(s.Lightformer,{form:"rect",intensity:2.2,color:"#cfe4f1",position:[4,1.5,1],rotation:[0,-Math.PI/2.4,0],scale:[6,6,1]}),(0,t.jsx)(s.Lightformer,{form:"circle",intensity:2.6,color:"#ffffff",position:[0,-2.6,-4],scale:[7,7,1]}),(0,t.jsx)(s.Lightformer,{form:"ring",intensity:1.4,color:"#f3e6c8",position:[1.5,2.5,-2],scale:[3,3,1]})]}),(0,t.jsx)("directionalLight",{position:[-4,5,3],intensity:1.1,color:"#fff4e0"})]})}e.s(["default",0,function({lite:e=!1}){let o=(0,u.useRef)({x:0,y:0});return(0,t.jsxs)("div",{className:"absolute inset-0",onPointerMove:e=>{let t=e.currentTarget.getBoundingClientRect();o.current.x=(e.clientX-t.left)/t.width*2-1,o.current.y=-((e.clientY-t.top)/t.height*2-1)},onPointerLeave:()=>{o.current.x=0,o.current.y=0},children:[(0,t.jsx)(r.Canvas,{orthographic:!0,camera:{zoom:1,position:[0,0,1]},dpr:[1,2],gl:{antialias:!1,alpha:!1,powerPreference:"high-performance"},style:{position:"absolute",inset:0},children:(0,t.jsx)(_,{pointer:o})}),(0,t.jsxs)(r.Canvas,{camera:{position:[0,0,5.2],fov:38},dpr:[1,2],gl:{antialias:!0,alpha:!0,powerPreference:"high-performance",toneMapping:m.ACESFilmicToneMapping},style:{position:"absolute",inset:0,pointerEvents:"none"},children:[(0,t.jsx)(F,{}),(0,t.jsx)(R,{pointer:o}),!e&&(0,t.jsx)(y,{count:28,scale:[6,5,3],size:2.4,speed:.28,opacity:.5,color:"#f3e6c8"}),(0,t.jsxs)(b.EffectComposer,{enableNormalPass:!1,children:[(0,t.jsx)(b.Bloom,{intensity:e?.9:1.35,luminanceThreshold:.62,luminanceSmoothing:.18,mipmapBlur:!0,kernelSize:M.KernelSize.LARGE}),(0,t.jsx)(b.Vignette,{eskil:!1,offset:.32,darkness:.78})]})]})]})}],38653)},78429,e=>{e.n(e.i(38653))}]);